...
function notFound() {
    if (MIGRATETONEW) {
        ...
        exit("The requested page was not found.");
    }
}
...
$app->get('/', function (Request $request, Response $response) {
    ...
    return $this->view->render($response, 'home.twig', [
        ...
        'releases' => [
            '1.15' => getReleases()->where('mc_version', '1.15.2')->first(),
...
$app->get('/update', function (Request $request, Response $response) {
    ...
    if (!$updateData->isHit()) {
        ...
        foreach (['1.15.2', '1.15.1', '1.14.4', '1.12.2', '1.12.1', '1.12', '1.11.2', '1.11', '1.10.2', '1.9.4', '1.9'] as $mcVersion) {
            $data[$mcVersion] = [];
